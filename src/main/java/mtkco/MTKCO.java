...
public class MTKCO implements Runnable, ConsumerRebalanceListener {
    ...
    private final Logger log = LoggerFactory.getLogger(MTKCO.class);
    private final String topic;
    private final String bservers;

    public MTKCO(String bservers, String topic) {
        this.topic = topic;
        this.bservers = bservers;
        Properties config = new Properties();
        config.put(ConsumerConfig.BOOTSTRAP_SERVERS_CONFIG, bservers);
        config.put(ConsumerConfig.KEY_DESERIALIZER_CLASS_CONFIG, StringDeserializer.class);
        config.put(ConsumerConfig.VALUE_DESERIALIZER_CLASS_CONFIG, StringDeserializer.class);
        config.put(ConsumerConfig.ENABLE_AUTO_COMMIT_CONFIG, false);
        config.put(ConsumerConfig.AUTO_OFFSET_RESET_CONFIG, "earliest");
        config.put(ConsumerConfig.GROUP_ID_CONFIG, "mtkco-demo");
