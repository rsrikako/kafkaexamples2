...
public class UserDataProducer {
    ...
    public static void main(String[] args) throws ExecutionException, InterruptedException, IOException {
        ...
        properties.setProperty(ProducerConfig.BOOTSTRAP_SERVERS_CONFIG, bservers);
        ...
        // We do .get() to ensure the writes to the topics are sequential, for the sake of understanding the things going on
    ...
    private static ProducerRecord<String, String> purchaseRecord(String key, String value){
        return new ProducerRecord<>(userPurchasesTopic, key, value);
    }
}
